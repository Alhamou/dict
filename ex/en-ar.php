...
if (strlen($word) >1){// دالة شرطية بعدد حروف  كلمة البحث
  ...
  $qexamples = "SELECT * FROM  english_examples WHERE ar LIKE '% $word %'LIMIT 7 ";
  ...
  if ($wc >= 1 ){while ($row_ex = $stmt->fetch()){
    ...
    $qexamples = "SELECT * FROM  english_examples WHERE ar LIKE '%$word%' AND ar NOT LIKE '% $word %' LIMIT 5 ";
