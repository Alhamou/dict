...
<div class="satz">
  <div class="">
    ...
    <div class="enabicword">
      ...
      <span class="discen"><?php echo $row["english_descreption"] ?></span>
    </div>
  </div>
  <div class="reexbutton">
    <form  class="exform" action="https://www.alhamou.com/exswen.php" method="GET">
      <input type="hidden" name="langs" value="en">
      <input type="hidden" name="examples" value="<?php echo $row["english_word"]?>">
