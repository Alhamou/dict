...
<?php
  ...
  echo " <title>إبحث عن كلمة في الأمثلة التركية - قاموس الحمو</title>";
};
...
<img src="../img/flags/tr.svg" alt="Turkish" class="sllim">
</div>
...
$word = trim($trip);// كلمة البحث المفلترة النهائية الجاهزة للبحث
  ...
  $qexamples = "SELECT * FROM  turkish_examples WHERE tr LIKE '% $word %' OR ar LIKE '% $word %'LIMIT 7 ";
  ...
  $qexamples = "SELECT * FROM  turkish_examples WHERE tr LIKE '%$word%' OR ar LIKE '%$word%'LIMIT 5 ";
