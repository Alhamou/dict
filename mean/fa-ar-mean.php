...
if (isset($_GET)&& $word!=""){
  ...
  echo "<div class='div-mean-word'><span id='doYouMean'>$word</span><p id='doYouMeanThis'>خطأ في الكلمة, لكن ربما تجدها هنا ؟</p></div>";
    ...
    // Array of terms
    $terms = [];
    $sql_mean = 'SELECT * FROM word_farsi_mean ';
           ...
           $find = $word;
             ...
             similar_text($value_ar,$find,$result_find);
              ...
              if ($result_find >=80) {
                ...
                $wordur2 = "swen.php?langs=".$select."&word=".$value["arabic_word_fl"]; // جلب الريسيرش للعربي
                include 'fa-ar-mean-result/mean-result-ar.php';
              } ;
               ...
               $find = $word;
                 ...
                 similar_text($value_tr,$find,$result_find);
                  ...
                  if ($result_find >=80) {
                    ...
                    $spakwordde = $value["farsi_word"];
                    $spakwordar = $value["arabic_word_fl"];
                    $wordurl = "swen.php?langs=".$select."&word=".$value["farsi_word"]; // جلب الريسيرش للاجنبي

                    include 'fa-ar-mean-result/mean-result-fa.php';
                  } ;
