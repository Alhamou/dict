...
if (isset($_GET)&& $word!=""){
  ...
  echo "<div class='div-mean-word'><span id='doYouMean'>$word</span><p id='doYouMeanThis'>خطأ في الكلمة, لكن ربما تجدها هنا ؟</p></div>";
    ...
    // Array of terms
    $terms = [];
    $sql_mean = 'SELECT * FROM word_french_mean';
           ...
           $find = $word;
             ...
             similar_text($value_ar,$find,$result_find);
              ...
              if ($result_find >=80) {
                ...
                include 'fr-ar-mean-result/mean-result-ar.php';
              } ;
               ...
               $find = $word;
                 ...
                 similar_text($value_en,$find,$result_find);
                  ...
                  if ($result_find >=80) {
                    ...
                    $spakwordde = $value["french_word"];
                    $spakwordar = $value["arabic_word_fl"];
                    $wordurl = "swen.php?langs=".$select."&word=".$value["french_word"]; // جلب الريسيرش للاجنبي

                    include 'fr-ar-mean-result/mean-result-fr.php';
                  } ;
