...
if (isset($_GET)&& $word!=""){
  ...
  echo "<div class='div-mean-word'><span id='doYouMean'>$word</span><p id='doYouMeanThis'>خطأ في الكلمة, لكن ربما تجدها هنا ؟</p></div>";
    ...
    // Array of terms
    $terms = [];
    $sql_mean = 'SELECT * FROM Mysqlenglishdictionary';
           ...
           $find = $word;
             ...
             similar_text($value_ar,$find,$result_find);
              ...
              if ($result_find >=80) {
                ...
                include 'mc-ar-mean-result/mean-result-ar.php';
              } ;
               ...
               $find = $word;
                 ...
                 similar_text($value_en,$find,$result_find);
                  ...
                  if ($result_find >=80) {
                    ...
                    $spakwordde = $value["english_word"];
                    $spakwordar = $value["arabic_word_fl"];
                    $wordurl = "swen.php?langs=".$select."&word=".$value["english_word"]; // جلب الريسيرش للاجنبي

                    include 'mc-ar-mean-result/mean-result-en.php';
                  } ;
