...
$sql_1 = "SELECT * FROM  word_english WHERE english_word LIKE '$word' LIMIT 10 ";
$sql_2 = "SELECT * FROM  word_english WHERE english_word LIKE '$word %' LIMIT 4 ";
$sql_3 ="SELECT * FROM  word_english WHERE english_word LIKE '% $word' AND english_word NOT LIKE '$word' LIMIT 4 ";
...
if($leng_3 > 0){while($row = $stmt_3->fetch()) {
  ...
  $sql_4 ="SELECT * FROM  word_english WHERE english_word LIKE '%$word%' AND english_word NOT LIKE '$word' LIMIT 4 ";
