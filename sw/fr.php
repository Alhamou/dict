...
if (isset($_GET)&& $word!=""){
  ...
  $sql_1 = "SELECT * FROM  word_french WHERE french_word LIKE '$word' LIMIT 10 ";
  $sql_2 = "SELECT * FROM  word_french WHERE french_word LIKE '$word %' LIMIT 4 ";
  $sql_3 ="SELECT * FROM  word_french WHERE french_word LIKE '% $word' AND french_word NOT LIKE '$word' LIMIT 4 ";
  ...
  if($leng_3 > 0){while($row = $stmt_3->fetch()) {
    ...
    $sql_4 ="SELECT * FROM  word_french WHERE french_word LIKE '%$word%' AND french_word NOT LIKE '$word' LIMIT 4 ";
    ...
    foreach( $ssmean as $term ) {
      ...
      foreach ($terms as $value) {
        ...
        if ($result_find >=80) {
          ...
          $wordurl = "swen.php?langs=fr&word=".$value["french_word"];
