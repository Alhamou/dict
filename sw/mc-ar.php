...
if (isset($_GET)&& $word!=""){
  ...
  $sql_1 ="SELECT * FROM  medicine WHERE arabic_word_fl LIKE '$word' LIMIT 10 ";
  $sql_2 ="SELECT * FROM  medicine WHERE arabic_word_fl LIKE '$word %' LIMIT 4 ";
  $sql_3 ="SELECT * FROM  medicine WHERE arabic_word_fl LIKE '% $word' AND arabic_word_fl NOT LIKE '$word' LIMIT 4 ";
...
$sql_4 ="SELECT * FROM  medicine WHERE arabic_word LIKE '$word' LIMIT 10 ";
  ...
  foreach( $ssmean as $term ) {
    ...
    foreach ($terms as $value) {
      ...
      if ($result_find >=80) {
        ...
        $wordur2 = "swar.php?langs=mc&word=".$value["arabic_word_fl"];
